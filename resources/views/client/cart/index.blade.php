...
@section('content')
    <div class="empty-cart {{ count($carts) == 0 ? '' : 'uk-hidden' }}">
        @include('client.cart.component.empty-cart')
    </div>
                    ...
                    <div class="uk-grid uk-grid-medium">
                        <div class="uk-width-large-3-5">
                            <div class="panel-cart cart-left">
                                @include('client.cart.component.information', ['model' => $customer])
                                @include('client.cart.component.method')
                        ...
                        <div class="uk-width-large-2-5">
                            <div class="panel-cart">
                                ...
                                @include('client.cart.component.item')
                                @include('client.cart.component.voucher')
                                @include('client.cart.component.summary')
                            </div>
                        </div>
                    </div>
                </div>
