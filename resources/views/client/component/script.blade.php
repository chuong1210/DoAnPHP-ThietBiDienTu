@php
    $coreScript = [
        ...
        'client/resources/plugins/wow/dist/wow.min.js',
        'client/resources/uikit/js/uikit.min.js',
        'client/resources/uikit/js/components/sticky.min.js',
        'client/core/plugins/jquery-nice-select-1.1.0/js/jquery.nice-select.min.js',
        'client/resources/function.js',
    ];
    if (isset($config['js'])) {
