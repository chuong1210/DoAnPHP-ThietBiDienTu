...
<div class="product-item product">
    ...
    <div class="tools">
        <a href="{{ $canonical }}" title="{{ $name }}"><img src="{{ asset('client/resources/img/trend.svg') }}"
                alt="{{ $name }}"></a>
        <a href="{{ $canonical }}" title="{{ $name }}"><img src="{{ asset('client/resources/img/wishlist.svg') }}"
                alt="{{ $name }}"></a>
        <a href="{{ $canonical }}" title="{{ $name }}"><img src="{{ asset('client/resources/img/compare.svg') }}"
                alt="{{ $name }}"></a>
        <a href="#popup" data-uk-modal title="{{ $name }}"><img src="{{ asset('client/resources/img/view.svg') }}"
                alt="{{ $name }}"></a>
    </div>
</div>