<div class="panel-body">
    ...
    <div class="uk-grid uk-grid-medium">
        <div class="uk-width-large-3-4">
            <div class="uk-grid uk-grid-medium">
                ...
                <div class="uk-width-large-2-3">
                    <div class="popup-product">
                        ...
                        @include('client.product.product.component.variant')
                        <div class="quantity">
                            ...
                            <div class="uk-flex uk-flex-middle">
                                <div class="quantitybox uk-flex uk-flex-middle">
                                    <div class="minus quantity-button"><img
                                            src="{{ asset('client/resources/img/minus.svg') }}" alt=""></div>
                                    <input type="text" name="" value="1" class="quantity-text int">
                                    <div class="plus quantity-button"><img
                                            src="{{ asset('client/resources/img/plus.svg') }}" alt="">
                                    </div>
                                </div>
            ...
            @include('client.product.product.component.review', [
                'model' => $product,
