...
@section('content')
    @include('client.component.backgroundHome')
    @include('client.component.homePopup')
                ...
                @if (isset($widgets[App\Enums\WidgetEnum::CATEGORY_MENU]->object))
                    <div class="panel-head">
                        <div class="uk-flex uk-flex-middle">
                            ...
                            @include('client.component.catalogue', [
                                    ...
                                    @foreach ($category->products as $product)
                                        ...
                                        @foreach ($product->product_variants as $productVariant)
                                            ...
                                            <div class="uk-width-large-1-5 mb20">
                                                @include('client.component.product-item', [
                                                    'product' => $product,
                        ...
                        <div class="swiper-container deal-container">
                            <div class="swiper-wrapper">
                                @foreach ($widgets[App\Enums\WidgetEnum::FEATURED_NEWS]->object as $key => $val)
                                    <div class="swiper-slide">
                                        @include('client.component.news_item', [
                                            'news' => $val,
                                        ])
                                    </div>
                                @endforeach
                ...
                <div class="uk-grid uk-grid-medium">
                    <div class="uk-width-large-1-5">
                        <div class="commit-item">
                            <div class="uk-flex uk-flex-middle">
                                <span class="image"><img src="{{ asset('client/resources/img/commit-1.png') }}"
                    ...
                    <div class="uk-width-large-1-5">
                        <div class="commit-item">
                            <div class="uk-flex uk-flex-middle">
                                <span class="image"><img src="{{ asset('client/resources/img/commit-2.png') }}"
                    ...
                    <div class="uk-width-large-1-5">
                        <div class="commit-item">
                            <div class="uk-flex uk-flex-middle">
                                <span class="image"><img src="{{ asset('client/resources/img/commit-3.png') }}"
                    ...
                    <div class="uk-width-large-1-5">
                        <div class="commit-item">
                            <div class="uk-flex uk-flex-middle">
                                <span class="image"><img src="{{ asset('client/resources/img/commit-4.png') }}"
                    ...
                    <div class="uk-width-large-1-5">
                        <div class="commit-item">
                            <div class="uk-flex uk-flex-middle">
                                <span class="image"><img src="{{ asset('client/resources/img/commit-5.png') }}"
