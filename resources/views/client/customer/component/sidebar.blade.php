<div class="col-lg-3 sidebar">
    ...
    <ul class="list-unstyled">
        <li class="no-boder"><img src="client/img/icons8-sale-100.png" alt="">
            <a href="#">25.10 SaleTo</a>
        </li>
        <li class="no-boder"><img src="client/img/icons8-account-100.png" alt="">
        ...
        <li class="no-boder"><a
                href="{{ route('customer.changePassword') }}">{{ __('customerInfo.change_password') }}</a></li>
        <li class="no-boder"><a href="#">{{ __('customerInfo.notify') }}</a></li>
        <li class="no-boder"><a href="#">{{ __('customerInfo.privacy_settings') }}</a></li>
        <li class="no-boder"><img src="client/img/icons8-bill-100.png" alt=""><a
                href="{{ route('order.viewOrder') }}">{{ __('customerInfo.bill') }}</a></li>
        <li class="no-boder"><img src="client/img/icons8-bell-100.png" alt=""><a
                href="">{{ __('customerInfo.notify') }}</a></li>
        <li class="no-boder"><img src="client/img/icons8-card-100.png" alt=""><a
