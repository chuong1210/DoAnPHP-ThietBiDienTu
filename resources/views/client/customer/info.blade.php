        ...
        <div class="panel-category">
            <div class="uk-container uk-container-center">
                <div class="container-fluid">
                    <div class="row">
                        <!-- Sidebar -->
                        @include('client.customer.component.sidebar')
                            ...
                            <div class="row">
                                ...
                                <form class="profile-form" method="post" action="{{ route('customer.updateInfo') }}"
                                    ...
                                    <div class="col-lg-9 mt-2">
                                        ...
                                        <div class="mt-3 row">
                                            <label for="name"
                                                class="col-sm-2 col-form-label mt-1">{{ __('customerInfo.name') }}</label>
                                            <div class="col-sm-9">
                                        ...
                                        <div class="mt-3 row">
                                            <label for="phone"
                                                class="col-sm-2 col-form-label mt-1">{{ __('customerInfo.phone') }}</label>
                                            <div class="col-sm-9">
                                        ...
                                        <div class="mt-3 row">
                                            <label for="birthday"
                                                class="col-sm-2 col-form-label mt-1">{{ __('customerInfo.birthday') }}</label>
                                            <div class="col-sm-3">
                                        ...
                                        <div class="mt-3 row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="submit" class="btn button-default"
                                                    value="{{ __('customerInfo.save') }}"></input>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="text-center">
                                            <span>
                                                <img src="storage/{{ old('image', $customer->image ?? 'backend/img/no-photo.png') }}"
                                                    alt="Ảnh khách hàng" id="previewImage"
