                ...
                <tbody>
                    @forelse($products as $product)
                        <tr>
                            ...
                            <td>
                                <img src="{{ asset($product->image ?? 'https://placehold.co/60x60/F8FAFC/CBD5E1?text=No+Image') }}"
                            ...
                            <td>
                                <span style="color: #64748B;">{{ $product->category->name ?? 'N/A' }}</span>
                            </td>
                            <td>
                                <span style="color: #64748B;">{{ $product->brand->name ?? 'N/A' }}</span>
                            </td>
                            <td>
                                ...
                                @else
                                    <div class="price-current">{{ number_format($product->price) }}đ</div>
                                @endif
                            </td>
