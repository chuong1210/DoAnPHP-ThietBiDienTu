        ...
        <div class="card-body" style="padding: 32px;">
            <form action="{{ route('admin.banners.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="title" id="title" class="form-control @error('title') is-invalid @enderror" value="{{ old('title') }}" style="border-color: #CBD5E1; border-radius: 8px; padding: 10px 12px;" placeholder="Nhập tiêu đề banner">
                    @error('title')
                ...
                <div class="mb-3">
                    ...
                    <input type="file" name="image" id="image" class="form-control @error('image') is-invalid @enderror" accept="image/jpeg,image/png,image/jpg" style="border-color: #CBD5E1; border-radius: 8px; padding: 10px 12px;">
                ...
                <div class="mb-3">
                    ...
                    <input type="url" name="link" id="link" class="form-control @error('link') is-invalid @enderror" value="{{ old('link') }}" style="border-color: #CBD5E1; border-radius: 8px; padding: 10px 12px;" placeholder="https://example.com">
                    @error('link')
                        <div class="invalid-feedback" style="color: #FF6B68;">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="number" name="sort_order" id="sort_order" class="form-control" value="{{ old('sort_order', 0) }}" style="border-color: #CBD5E1; border-radius: 8px; padding: 10px 12px;" min="0">
                </div>

                <div class="mb-4">
                    <div class="form-check">
                        <input type="checkbox" name="is_active" id="is_active" class="form-check-input" value="1" {{ old('is_active', 1) ? 'checked' : '' }} style="border-color: #CBD5E1; accent-color: #0066FF; width: 18px; height: 18px; cursor: pointer;">
                ...
                <div class="d-flex gap-3">
                    ...
                    <a href="{{ route('admin.banners.index') }}" class="btn" style="background-color: #E0F2FE; color: #0066FF; border: none; padding: 12px 20px; border-radius: 8px; text-decoration: none; font-weight: 500;">
