...
<div class="container-fluid" style="background: linear-gradient(135deg, #F8FAFC 0%, #E0F2FE 100%); min-height: 100vh; padding: 20px 0;">
    ...
    <div class="mb-4" style="background: linear-gradient(135deg, #0066FF 0%, #00B4D8 100%); color: white; padding: 28px; border-radius: 12px; box-shadow: 0 4px 20px rgba(0, 102, 255, 0.2);">
        <div style="display: flex; align-items: center; gap: 12px;">
            ...
            <h1 class="h3 mb-0">Chi tiết liên hệ #<?php echo e($contact->id); ?></h1>
        </div>
    </div>
            ...
            <div style="display: grid; gap: 0;">
                ...
                <div style="padding: 20px; background-color: #F8FAFC; border-bottom: 1px solid #E2E8F0; display: flex; align-items: center; gap: 16px;">
                    ...
                    <div>
                        ...
                        <p style="margin: 0; color: #1E293B; font-size: 16px; font-weight: 600;">#<?php echo e($contact->id); ?></p>
                    </div>
                </div>
                ...
                <div style="padding: 20px; background-color: #FFFFFF; border-bottom: 1px solid #E2E8F0; display: flex; align-items: center; gap: 16px;">
                    ...
                    <div>
                        ...
                        <p style="margin: 0; color: #1E293B; font-size: 16px; font-weight: 600;"><?php echo e($contact->name); ?></p>
                    </div>
                </div>
                ...
                <div style="padding: 20px; background-color: #F8FAFC; border-bottom: 1px solid #E2E8F0; display: flex; align-items: center; gap: 16px;">
                    ...
                    <div>
                        ...
                        <p style="margin: 0; color: #0066FF; font-size: 15px; font-weight: 500;"><?php echo e($contact->email); ?></p>
                    </div>
                </div>

                <!-- Trạng thái -->
                <div style="padding: 20px; background-color: #FFFFFF; border-bottom: 1px solid #E2E8F0; display: flex; align-items: center; gap: 16px;">
                    <div style="background: <?php echo e($contact->status == 'new' ? '#F59E0B' : '#10B981'); ?>; color: white; width: 40px; height: 40px; border-radius: 50%; display: flex; align-items: center; justify-content: center;">
                    ...
                    <div>
                        ...
                        <span class="badge" style="background-color: <?php echo e($contact->status == 'new' ? '#F59E0B' : '#10B981'); ?>; color: white; padding: 8px 16px; border-radius: 6px; font-size: 14px; font-weight: 600;">
        ...
        <div class="card-body" style="padding: 28px; background: #FFFFFF;">
            <form action="<?php echo e(route('admin.contact.send', $contact->id)); ?>" method="POST">
                ...
                <div class="d-flex gap-3">
                    ...
                    <a href="<?php echo e(route('admin.contact.index')); ?>" class="btn" style="background-color: #E0F2FE; color: #0066FF; border: 1px solid #0066FF; padding: 14px 20px; border-radius: 10px; text-decoration: none; font-weight: 600; font-size: 15px;">
    ...
    <div class="mt-4 text-center">
        <a href="<?php echo e(route('admin.contact.index')); ?>" class="btn" style="background: linear-gradient(135deg, #0066FF 0%, #00B4D8 100%); color: white; border: none; padding: 14px 32px; border-radius: 10px; text-decoration: none; font-weight: 600; font-size: 15px; box-shadow: 0 4px 15px rgba(0, 102, 255, 0.3);">
...
<?php echo $__env->make('admin.layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\chuon\PHP\doanPHP\resources\views/admin/contacts/show.blade.php ENDPATH**/ ?>