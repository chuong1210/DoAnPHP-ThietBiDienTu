...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="highlight"><?php echo e($email); ?></div>
            ...
            <!-- CTA -->
            <a href="<?php echo e(url('/client/products-all')); ?>" class="cta-button">
        ...
        <div class="footer">
            ...
            <p>&copy; <?php echo e(date('Y')); ?> Tech Shop. All rights reserved.</p>
        </div>
    </div>
</body>

</html><?php /**PATH C:\Users\chuon\PHP\doanPHP\resources\views/emails/newsletter/welcome.blade.php ENDPATH**/ ?>