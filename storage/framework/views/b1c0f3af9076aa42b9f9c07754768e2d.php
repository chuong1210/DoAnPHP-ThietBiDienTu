                        ...
                        <tbody>
                            <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr style="border-bottom: 1px solid #CBD5E1; transition: background-color 0.2s;">
                                    ...
                                    <td style="color: #1E293B; padding: 15px; vertical-align: middle; font-weight: 500;"><?php echo e($user->full_name); ?></td>
                                    <td style="color: #1E293B; padding: 15px; vertical-align: middle;"><?php echo e($user->phone ?? '-'); ?></td>
                                    <td style="padding: 15px; vertical-align: middle;">
                                        <span class="badge" style="background-color: <?php echo e($user->role === 'admin' ? '#0066FF' : '#00B4D8'); ?>; color: white; padding: 6px 12px; border-radius: 6px; font-weight: 500;">
                                            <i class="fas <?php echo e($user->role === 'admin' ? 'fa-crown' : 'fa-user'); ?>"></i> <?php echo e(ucfirst($user->role)); ?>

                                        </span>
                                    </td>
                                    <td style="padding: 15px; vertical-align: middle;">
                                        <span class="badge" style="background-color: <?php echo e($user->status === 'active' ? '#10B981' : '#F59E0B'); ?>; color: white; padding: 6px 12px; border-radius: 6px; font-weight: 500;">
                                            <i class="fas <?php echo e($user->status === 'active' ? 'fa-check-circle' : 'fa-clock'); ?>"></i> <?php echo e(ucfirst($user->status)); ?>

                                        </span>
                                    </td>
                                    <td style="color: #1E293B; padding: 15px; vertical-align: middle;"><?php echo e($user->created_at->format('d/m/Y H:i')); ?></td>
                                    <td class="text-center" style="padding: 15px; vertical-align: middle;">
                                        <a href="<?php echo e(route('admin.users.edit', $user->id)); ?>" class="btn btn-sm" style="background-color: #ffedd5; color: #991b1b; border: none; border-radius: 6px; padding: 8px 12px; transition: all 0.2s;">
...
<?php echo $__env->make('admin.layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Nam4\PHP\DoAnPHP-ThietBiDienTu\resources\views/admin/users/index.blade.php ENDPATH**/ ?>