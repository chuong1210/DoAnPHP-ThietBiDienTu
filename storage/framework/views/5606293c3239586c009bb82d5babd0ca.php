    ...
    <section class="support-hero text-center position-relative">
        <div class="container position-relative">
            ...
            <div class="d-flex justify-content-center gap-3 flex-wrap">
                ...
                <a href="https://zalo.me/0784393356" target="_blank" class="btn btn-light btn-lg px-4">
        ...
        <div class="row g-4">
            ...
            <div class="col-lg-4">
                <div class="support-card">
                    ...
                    <div class="contact-item mb-3" onclick="window.open('https://zalo.me/0784393356', '_blank')">
