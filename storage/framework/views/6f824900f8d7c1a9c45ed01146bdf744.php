...
<?php $__env->startSection('content'); ?>
    ...
    <nav aria-label="breadcrumb" class="mb-4">
        <ol class="breadcrumb modern-breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="<?php echo e(route('client.profile.index')); ?>">Hồ sơ</a></li>
    ...
    <div class="container-fluid">
        ...
        <div class="filter-tabs">
            <button class="filter-tab <?php echo e(!request('status') ? 'active' : ''); ?>" data-status="all"
                onclick="filterReviews('all')">
                <i class="fas fa-list"></i>
                <span>Tất cả</span>
                <span class="badge"><?php echo e($reviews->total()); ?></span>
            </button>
            <button class="filter-tab <?php echo e(request('status') == 'pending' ? 'active' : ''); ?>" data-status="pending"
                onclick="filterReviews('pending')">
                <i class="fas fa-clock"></i>
                <span>Chờ duyệt</span>
                <span class="badge"><?php echo e($reviews->where('status', 'pending')->count()); ?></span>
            </button>
            <button class="filter-tab <?php echo e(request('status') == 'approved' ? 'active' : ''); ?>" data-status="approved"
                onclick="filterReviews('approved')">
                <i class="fas fa-check-circle"></i>
                <span>Đã duyệt</span>
                <span class="badge"><?php echo e($reviews->where('status', 'approved')->count()); ?></span>
            </button>
            <button class="filter-tab <?php echo e(request('status') == 'rejected' ? 'active' : ''); ?>" data-status="rejected"
                onclick="filterReviews('rejected')">
                <i class="fas fa-times-circle"></i>
                <span>Từ chối</span>
                <span class="badge"><?php echo e($reviews->where('status', 'rejected')->count()); ?></span>
            </button>
        </div>
        <!-- Reviews List -->
                ...
                <?php $__currentLoopData = $reviews; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $review): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="review-card">
                        ...
                        <div class="review-product-section">
                            <a href="<?php echo e(route('client.product.show', $review->product->slug)); ?>" class="product-link">
                                <div class="product-image-wrapper">
                                    <?php if($review->product->image): ?>
                                        <img src="<?php echo e(asset($review->product->image)); ?>" alt="<?php echo e($review->product->name); ?>">
                                    <?php else: ?>
                                ...
                                <div class="product-info">
                                    <h6 class="product-name"><?php echo e(Str::limit($review->product->name, 60)); ?></h6>
                                    <div class="product-brand"><?php echo e($review->product->brand->name); ?></div>
                                </div>
                            </a>
                        </div>
                        ...
                        <div class="review-content-section">
                            ...
                            <div class="review-header">
                                <div class="rating-stars">
                                    <?php for($i = 1; $i <= 5; $i++): ?>
                                        ...
                                        <?php endif; ?>
                                    <?php endfor; ?>
                                    <span class="rating-number"><?php echo e($review->rating); ?>/5</span>
                                </div>
                            ...
                            <div class="review-actions">
                                <a href="<?php echo e(route('client.product.show', $review->product->slug)); ?>" class="btn-action view">
                                    <i class="fas fa-eye"></i> Xem sản phẩm
                                </a>
                                <?php if($review->status === 'pending'): ?>
                                    <button type="button" class="btn-action edit"
                                        onclick="editReview(<?php echo e($review->id); ?>, <?php echo e($review->rating); ?>, '<?php echo e(addslashes($review->comment)); ?>')">
                                        <i class="fas fa-edit"></i> Sửa
                                    </button>
                                    <button type="button" class="btn-action delete" onclick="deleteReview(<?php echo e($review->id); ?>)">
        ...
        <?php else: ?>
            ...
            <div class="empty-state">
                ...
                <a href="<?php echo e(route('client.product.index')); ?>" class="btn-empty-action">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="star-rating-input">
                                <?php for($i = 5; $i >= 1; $i--): ?>
                                    <input type="radio" name="rating" id="edit_star<?php echo e($i); ?>" value="<?php echo e($i); ?>" required>
                                    <label for="edit_star<?php echo e($i); ?>">
                                        <i class="fas fa-star"></i>
                                    </label>
                                <?php endfor; ?>
                            </div>
...
<?php $__env->startSection('scripts'); ?>
    <script>
        function filterReviews(status) {
            if (status === 'all') {
                window.location.href = '<?php echo e(route("client.profile.reviews")); ?>';
            } else {
                window.location.href = '<?php echo e(route("client.profile.reviews")); ?>?status=' + status;
            }
        }
...
<?php echo $__env->make('client.layouts.client', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\chuon\PHP\doanPHP\resources\views/client/profile/review.blade.php ENDPATH**/ ?>