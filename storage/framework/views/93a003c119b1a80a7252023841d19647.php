    ...
    <div class="top-bar-actions">
        ...
        <div class="dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-end" style="min-width: 300px;">
                ...
                <?php if($totalNotifications > 0): ?>
                    <li>
                        <a class="dropdown-item" href="<?php echo e(route('admin.chat.index')); ?>">
                            <i class="fas fa-comment text-danger me-2"></i>
                            <span><?php echo e($totalNotifications); ?> tin nhắn mới</span>
                        </a>
                    </li>
                <?php else: ?>
        ...
        <div class="dropdown">
            <button class="btn btn-light d-flex align-items-center gap-2" type="button" data-bs-toggle="dropdown">
                ...
                <span class="d-none d-md-inline"><?php echo e(Auth::user()->full_name); ?></span>
...
</style><?php /**PATH D:\Nam4\PHP\DoAnPHP-ThietBiDienTu\resources\views/admin/partials/header.blade.php ENDPATH**/ ?>