...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mb-3">
                        <label for="image" class="form-label"
                            style="color: #1E293B; font-weight: 600; margin-bottom: 8px;">Hình ảnh</label>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mb-3">
                        ...
                        <select name="sort_order" id="sort_order"
                            class="form-select <?php $__errorArgs = ['sort_order'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                            ...
                            <?php for($i = 1; $i <= $activeBannerCount; $i++): ?>
                                <option value="<?php echo e($i); ?>" <?php echo e(old('sort_order', $banner->sort_order) == $i ? 'selected' : ''); ?>>
                                    Vị trí <?php echo e($i); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mb-4">
                        <div class="form-check">
                            <input type="checkbox" name="is_active" id="is_active" class="form-check-input" value="1" <?php echo e(old('is_active', $banner->is_active) ? 'checked' : ''); ?>

                                style="border-color: #CBD5E1; accent-color: #0066FF;">
                    ...
                    <div class="d-flex gap-3">
                        <button type="submit" class="btn grow"
                            style="background: linear-gradient(135deg, #0066FF 0%, #00B4D8 100%); color: white; border: none; padding: 12px 20px; border-radius: 8px; font-weight: 500;">
                            <i class="fas fa-save"></i> Cập nhật
                        </button>
                        <a href="<?php echo e(route('admin.banners.index')); ?>" class="btn"
                            style="background-color: #E0F2FE; color: #0066FF; border: none; padding: 12px 20px; border-radius: 8px; text-decoration: none;">
...
<?php echo $__env->make('admin.layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\chuon\PHP\doanPHP\resources\views/admin/banners/edit.blade.php ENDPATH**/ ?>