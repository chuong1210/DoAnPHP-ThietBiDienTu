...
<?php $__env->startSection('content'); ?>
    ...
    <nav aria-label="breadcrumb" class="mb-4">
        ...
        <ol class="breadcrumb breadcrumb-frameless">
            ...
            <li class="breadcrumb-item">
                <a href="<?php echo e(route('client.product.category.index', $product->category->slug)); ?>">
            ...
            <div class="product-images-section">
                <div class="main-image-wrapper">
                    <?php if($product->image): ?>
                        <img src="<?php echo e(asset($product->image)); ?>" class="main-image" alt="<?php echo e($product->name); ?>" id="mainImage">
                    <?php else: ?>
                ...
                <?php if(!empty($product->images)): ?>
                    <div class="gallery-thumbnails">
                        <div class="thumbnail-item active">
                            <img src="<?php echo e(asset($product->image)); ?>" alt="Main"
                                onclick="changeMainImage('<?php echo e(asset($product->image)); ?>', this)">
                        </div>
                        <?php $__currentLoopData = $product->images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="thumbnail-item">
                                <img src="<?php echo e(asset($image)); ?>" alt="Gallery" onclick="changeMainImage('<?php echo e(asset($image)); ?>', this)">
                            </div>
        ...
        <div class="col-lg-7">
            <div class="product-info-section">
                ...
                <div class="product-brand">
                    ...
                    <a href="<?php echo e(route('client.brand.index', $product->brand->slug)); ?>">
                ...
                <div class="product-stats">
                    <div class="rating-stars">
                        <?php for($i = 1; $i <= 5; $i++): ?>
                            ...
                            <?php endif; ?>
                        <?php endfor; ?>
                        <span class="rating-score"><?php echo e(number_format($averageRating, 1)); ?></span>
                        <span class="rating-count">(<?php echo e($reviews->total()); ?> đánh giá)</span>
                    </div>
                    <div class="view-count">
                        <i class="fas fa-eye"></i>
                        <span><?php echo e(number_format($product->view_count)); ?> lượt xem</span>
                    </div>
                </div>
                ...
                <div class="product-pricing">
                    <?php if($product->sale_price): ?>
                        <div class="price-wrapper sale">
                            <span class="current-price"><?php echo e(number_format($product->sale_price)); ?>đ</span>
                            <span class="original-price"><?php echo e(number_format($product->price)); ?>đ</span>
                        </div>
                    <?php else: ?>
                        <div class="price-wrapper">
                            <span class="current-price"><?php echo e(number_format($product->price)); ?>đ</span>
                        </div>
                    <?php endif; ?>
                </div>
                ...
                <div class="stock-status">
                    ...
                    <?php if($product->quantity > 0): ?>
                        <div class="status-badge available">
                            ...
                            Còn <?php echo e($product->quantity); ?> sản phẩm
                        </div>
                    <?php else: ?>
                ...
                <!-- Add to Cart Form -->
                <?php if($product->quantity > 0): ?>
                    <form action="<?php echo e(route('client.cart.add', $product->id)); ?>" method="POST" class="cart-form">
                        <?php echo csrf_field(); ?>
                        <div class="quantity-selector">
                            ...
                            <div class="quantity-input">
                                ...
                                <input type="number" name="quantity" id="quantity" value="1" min="1"
                                    max="<?php echo e($product->quantity); ?>" readonly>
            ...
            <ul class="nav nav-tabs details-tabs" role="tablist">
                ...
                <li class="nav-item">
                    <button class="nav-link" data-bs-toggle="tab" data-bs-target="#reviews">
                        <i class="fas fa-star"></i> Đánh Giá <span class="tab-count">(<?php echo e($reviews->total()); ?>)</span>
                    </button>
                </li>
            </ul>
                    ...
                    <?php if($reviews->count() > 0): ?>
                        <div class="reviews-summary">
                            <div class="summary-score">
                                <div class="score-number"><?php echo e(number_format($averageRating, 1)); ?></div>
                                ...
                                <div class="score-count"><?php echo e($reviews->total()); ?> đánh giá</div>
                            </div>
                        </div>
                                ...
                                <div class="review-item">
                                    <div class="review-header">
                                        ...
                                        <div class="reviewer-info">
                                            <strong class="reviewer-name"><?php echo e($review->user->full_name); ?></strong>
                ...
                <?php $__currentLoopData = $relatedProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $related): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="col-lg-3 col-md-6">
                        <div class="related-product-card">
                            <a href="<?php echo e(route('client.product.show', $related->slug)); ?>" class="product-link">
                                <div class="product-image-wrapper">
                                    <?php if($related->image): ?>
                                        <img src="<?php echo e(asset($related->image)); ?>" alt="<?php echo e($related->name); ?>" loading="lazy">
                                    <?php else: ?>
                                        <div class="image-placeholder">
                                            <i class="fas fa-image"></i>
                                        </div>
                                ...
                                <div class="product-info">
                                    <div class="product-brand-small"><?php echo e($related->brand->name ?? 'N/A'); ?></div>
                                    <h6 class="product-name-small"><?php echo e(Str::limit($related->name, 50)); ?></h6>
                                    <div class="product-price-small">
                                        <?php if($related->sale_price): ?>
                                            <span class="price-current"><?php echo e(number_format($related->sale_price)); ?>đ</span>
                                            <span class="price-old"><?php echo e(number_format($related->price)); ?>đ</span>
                                        <?php else: ?>
                                            <span class="price-current"><?php echo e(number_format($related->price)); ?>đ</span>
                                        <?php endif; ?>
                                    </div>
                                </div>
                            </a>
...
<?php $__env->startSection('scripts'); ?>
    <script>
        ...
        function confirmBuyNow() {
            ...
            form.action = '<?php echo e(route("client.cart.add", ":id")); ?>'.replace(':id', buyNowProduct.id); form.method = 'POST';
