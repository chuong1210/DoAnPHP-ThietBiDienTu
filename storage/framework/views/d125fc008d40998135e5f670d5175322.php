...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid"
        ...
        <!-- Updated header with Tech Blue Pro gradient and modern styling -->
        <div class="mb-4"
            ...
            <div style="display: flex; align-items: center; gap: 12px;">
                <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2"
                    ...
                    <path d="M16 3H8a2 2 0 0 0-2 2v5h12V5a2 2 0 0 0-2-2z"></path>
                </svg>
        ...
        <!-- Add Button -->
        <a href="<?php echo e(route('admin.banners.create')); ?>" class="btn btn-lg mb-4"
            style="background: linear-gradient(135deg, #0066FF 0%, #00B4D8 100%); color: white; border: none; padding: 12px 24px; border-radius: 8px; box-shadow: 0 4px 15px rgba(0, 102, 255, 0.3); font-weight: 500;">
            <i class="fas fa-plus"></i> Thêm Banner
        </a>

        <!-- Banner Table with modern design -->
        <div class="card shadow-sm"
            style="border: 1px solid #CBD5E1; border-radius: 12px; overflow: hidden; box-shadow: 0 2px 12px rgba(0, 0, 0, 0.05);">
                        ...
                        <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = $banners; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $banner): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr style="border-bottom: 1px solid #CBD5E1; transition: background-color 0.2s;">
                                        ...
                                        <?php if($banner->image): ?>
                                            <a href="#" data-bs-toggle="modal" data-bs-target="#imageModal<?php echo e($banner->id); ?>">
                                                <img src="<?php echo e(asset($banner->image)); ?>" alt="<?php echo e($banner->title); ?>"
                                                    style="max-width: 80px; height: 60px; object-fit: cover; border-radius: 6px; border: 2px solid #E0F2FE;">
                                            </a>
                                            <!-- Modal -->
                                                ...
                                                <div class="modal-dialog modal-lg">
                                                    <div class="modal-content"
                                                        ...
                                                        <div class="modal-header"
                                                            style="background: linear-gradient(135deg, #0066FF 0%, #00B4D8 100%); color: white; border: none; padding: 20px;">
                                                            <h5 class="modal-title" id="imageModalLabel<?php echo e($banner->id); ?>">
                                    ...
                                    <td style="color: #1E293B; padding: 16px;">
                                        <?php if($banner->link): ?>
                                            <a href="<?php echo e($banner->link); ?>" target="_blank"
                                                style="color: #0066FF; text-decoration: none; font-size: 13px;"><?php echo e(\Illuminate\Support\Str::limit($banner->link, 20)); ?></a>
                                        <?php else: ?>
                                            -
                                        <?php endif; ?>
                                    </td>
                                    ...
                                    <td style="padding: 16px;">
                                        <span class="badge"
                                            style="background-color: <?php echo e($banner->is_active ? '#00B4D8' : '#CBD5E1'); ?>; color: white; padding: 6px 12px; border-radius: 4px;">
                                            <?php echo e($banner->is_active ? 'Hiển thị' : 'Ẩn'); ?>

                                        </span>
                                    </td>
                                    <td style="padding: 16px; display: flex; gap: 8px;">
                                        <a href="<?php echo e(route('admin.banners.edit', $banner->id)); ?>" class="btn btn-sm"
                                            style="background: linear-gradient(135deg, #0066FF 0%, #00B4D8 100%); color: white; border: none; text-decoration: none; padding: 6px 12px; border-radius: 6px;">
                                        ...
                                        <form action="<?php echo e(route('admin.banners.destroy', $banner->id)); ?>" method="POST"
                                            ...
                                            <button type="submit" class="btn btn-sm"
                                                style="background-color: #E0F2FE; color: #0066FF; border: none; padding: 6px 12px; border-radius: 6px;">
