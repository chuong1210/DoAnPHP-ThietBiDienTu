                        ...
                        <?php $__empty_1 = true; $__currentLoopData = $banners; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $banner): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr style="border-bottom: 1px solid #CBD5E1; transition: background-color 0.2s;">
                                ...
                                <td style="padding: 16px; display: flex; gap: 8px;">
                                    <a href="<?php echo e(route('admin.banners.edit', $banner->id)); ?>" class="btn btn-sm" style="background: linear-gradient(135deg, #0066FF 0%, #00B4D8 100%); color: white; border: none; text-decoration: none; padding: 6px 12px; border-radius: 6px;">
                                    ...
                                    <form action="<?php echo e(route('admin.banners.destroy', $banner->id)); ?>" method="POST" style="display: inline-block;" onsubmit="return confirm('Bạn có chắc chắn muốn xóa?');">
                                        ...
                                        <button type="submit" class="btn btn-sm" style="background-color: #E0F2FE; color: #0066FF; border: none; padding: 6px 12px; border-radius: 6px;">
