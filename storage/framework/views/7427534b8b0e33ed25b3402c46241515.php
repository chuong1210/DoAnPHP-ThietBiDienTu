...
<div class="container-fluid" style="background-color: #FFF5F7; min-height: 100vh; padding: 20px 0;">
    ...
    <a href="<?php echo e(route('admin.faqs.create')); ?>" class="btn mb-4" style="background: linear-gradient(135deg, #FF3B3F 0%, #FF6B81 100%); color: white; border: none; padding: 0.75rem 1.5rem;">
                    ...
                    <div class="accordion-item border-0">
                        <h2 class="accordion-header" id="heading<?php echo e($loop->index); ?>">
                            <button class="accordion-button collapsed fw-medium" type="button"
                                    ...
                                    style="background: linear-gradient(135deg, #FF3B3F 0%, #FF6B81 100%); color: white; font-weight: 600;">
                                <i class="<?php echo e($cat['icon']); ?> me-2"></i>
                                <?php echo e($cat['name']); ?> (<?php echo e($items->count()); ?>)
                            </button>
                        </h2>
                            ...
                            <div class="accordion-body p-0">
                                ...
                                <?php else: ?>
                                    <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $faq): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div style="border-bottom: 1px solid #F0D9DE; padding: 16px;">
