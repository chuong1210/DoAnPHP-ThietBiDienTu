<?php $__env->startSection('title', 'Trang Chủ - Tech Shop'); ?>
<?php
    $hideSidebar = true;
?>
                ...
                <?php $__currentLoopData = $banners; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $banner): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="carousel-item <?php echo e($index === 0 ? 'active' : ''); ?>">
                        <div class="banner-wrapper">
                            <img src="<?php echo e(asset($banner->image)); ?>" class="d-block w-100" alt="<?php echo e($banner->title); ?>">
                            <div class="banner-overlay">
                                <div class="container">
                                    <div class="banner-content">
                                        ...
                                        <a href="<?php echo e(route('client.product.index')); ?>" class="btn-banner">
    ...
    <section class="products-section mb-5">
        <div class="container">
            <div class="section-header">
                ...
                <a href="<?php echo e(route('client.product.all')); ?>" class="btn-view-all">
                        ...
                        <div class="product-card" style="animation-delay: <?php echo e($index * 0.1); ?>s">
                            ...
                            <div class="product-image-wrapper">
                                ...
                                <div class="product-overlay">
                                    <a href="<?php echo e(route('client.product.show', $product->slug)); ?>" class="btn-quick-view">
                            ...
                            <div class="product-info">
                                ...
                                <div class="product-price">
                                    <?php if($product->sale_price): ?>
                                        <span class="price-current"><?php echo e(number_format($product->sale_price)); ?>đ</span>
                                ...
                                <div class="product-actions">
                                    <a href="<?php echo e(route('client.product.show', $product->slug)); ?>" class="btn-add-cart">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="product-card" style="animation-delay: <?php echo e($index * 0.1); ?>s">
                            ...
                            <div class="product-info">
                                ...
                                <div class="product-price">
                                    <span class="price-current"><?php echo e(number_format($product->final_price)); ?>đ</span>
                                </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('client.layouts.client', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Nam4\PHP\DoAnPHP-ThietBiDienTu\resources\views/client/home/index.blade.php ENDPATH**/ ?>