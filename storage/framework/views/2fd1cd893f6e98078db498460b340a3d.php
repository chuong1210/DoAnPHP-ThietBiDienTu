...
<?php $__env->startSection('content'); ?>
    <div class="container py-4">
            ...
            <div class="container position-relative">
                <div class="row align-items-center">
                    <div class="col-lg-8">
                        ...
                        <h3 class="header-number">#<?php echo e($order->order_number); ?></h3>
                        <div class="header-meta">
                            <span><i class="far fa-calendar-alt"></i> <?php echo e($order->created_at->format('d/m/Y H:i')); ?></span>
                            <span><i class="fas fa-box"></i> <?php echo e($order->items->count()); ?> sản phẩm</span>
                    ...
                    <div class="col-lg-4 text-lg-end mt-3 mt-lg-0">
                        <div class="header-total-wrapper">
                            ...
                            <h1 class="total-amount"><?php echo e(number_format($order->total)); ?>đ</h1>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="action-buttons-bar no-print">
            <a href="<?php echo e(route('client.my-orders.index')); ?>" class="btn-action back">
            ...
            <?php if($order->canCancel()): ?>
                <form action="<?php echo e(route('client.my-orders.cancel', $order)); ?>" method="POST" class="d-inline">
                    <?php echo csrf_field(); ?>
        ...
        <div class="row g-4">
                        ...
                        <div class="timeline-container">
                            ...
                            <div class="timeline-step completed">
                                ...
                                <div class="step-content">
                                    ...
                                    <p class="step-time"><?php echo e($order->created_at->format('d/m/Y H:i')); ?></p>
                            ...
                            <!-- Step 2: Confirmed -->
                            <div
                                class="timeline-step <?php echo e(in_array($order->status, ['confirmed', 'shipping', 'delivered']) ? 'completed' : ''); ?> <?php echo e($order->status === 'confirmed' ? 'active' : ''); ?>">
                                <div class="step-indicator">
                                    <div class="step-circle">
                                ...
                                <div class="step-content">
                                    ...
                                    <p class="step-time">
                                        <?php echo e(in_array($order->status, ['confirmed', 'shipping', 'delivered']) ? $order->updated_at->format('d/m/Y H:i') : 'Chờ xác nhận...'); ?>
                            ...
                            <!-- Step 3: Shipping -->
                            <div
                                class="timeline-step <?php echo e(in_array($order->status, ['shipping', 'delivered']) ? 'completed' : ''); ?> <?php echo e($order->status === 'shipping' ? 'active' : ''); ?>">
                                <div class="step-indicator">
                                    <div class="step-circle">
                                ...
                                <div class="step-content">
                                    ...
                                    <p class="step-time">
                                        <?php echo e($order->status === 'shipping' || $order->status === 'delivered' ? $order->updated_at->format('d/m/Y H:i') : 'Chờ vận chuyển...'); ?>
                            ...
                            <!-- Step 4: Delivered -->
                            <div
                                class="timeline-step <?php echo e($order->status === 'delivered' ? 'completed' : ''); ?> <?php echo e($order->status === 'delivered' ? 'active' : ''); ?>">
                                <div class="step-indicator">
                                    <div class="step-circle">
                                ...
                                <div class="step-content">
                                    ...
                                    <p class="step-time">
                                        <?php echo e($order->status === 'delivered' ? $order->updated_at->format('d/m/Y H:i') : 'Chưa giao...'); ?>
                            ...
                            <?php $__currentLoopData = $order->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="product-item-detail">
                                    ...
                                    <div class="product-info-wrapper">
                                        <h6 class="product-name"><?php echo e($item->product_name); ?></h6>
                                        <div class="product-meta">
                                            <span class="quantity">Số lượng: <?php echo e($item->quantity); ?></span>
                                            <span class="price">Đơn giá: <?php echo e(number_format($item->price)); ?>đ</span>
                                        </div>
                                    </div>
            ...
            <div class="col-lg-4">
                ...
                <div class="summary-card">
                    ...
                    <div class="summary-amount"><?php echo e(number_format($order->total)); ?>đ</div>
                    <?php if($order->discount > 0): ?>
                        <small class="summary-note">Đã tiết kiệm <?php echo e(number_format($order->discount)); ?>đ</small>
                    <?php endif; ?>
                </div>
                    ...
                    <div class="info-card-body">
                        ...
                        <div class="info-row address">
                            ...
                            <span>
                                ...
                                <?php if($order->shipping_ward): ?>, <?php echo e($order->shipping_ward); ?><?php endif; ?>
                ...
                <div class="info-card">
                    ...
                    <div class="info-card-body">
                        <div class="payment-row">
                            <span>Tạm tính:</span>
                            <strong><?php echo e(number_format($order->subtotal)); ?>đ</strong>
                        </div>
                        <div class="payment-row">
                            <span>Phí vận chuyển:</span>
                            <strong><?php echo e(number_format($order->shipping_fee)); ?>đ</strong>
                        </div>
                        <?php if($order->discount > 0): ?>
                            <div class="payment-row discount">
                                <span>Giảm giá:</span>
                                <strong>-<?php echo e(number_format($order->discount)); ?>đ</strong>
                            </div>
                        <?php endif; ?>
                        <div class="payment-divider"></div>
                        <div class="payment-row total">
                            <span>Tổng cộng:</span>
                            <strong><?php echo e(number_format($order->total)); ?>đ</strong>
                        </div>
    ...
    <div class="print-section" style="display: none;">
        <div class="container mt-5">
            <div class="text-center mb-4">
                ...
                <p>#<?php echo e($order->order_number); ?> | <?php echo e($order->created_at->format('d/m/Y H:i')); ?></p>
            </div>
            ...
            <p class="text-end"><strong>Tổng: <?php echo e(number_format($order->total)); ?>đ</strong></p>
            <p>Giao đến: <?php echo e($order->shipping_address); ?></p>
        </div>
    </div>
...
<?php echo $__env->make('client.layouts.client', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\chuon\PHP\doanPHP\resources\views/client/orders/detail.blade.php ENDPATH**/ ?>