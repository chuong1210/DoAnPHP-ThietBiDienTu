<?php $__env->startSection('title', 'Tìm kiếm: ' . $keyword); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="search-header">
        ...
        <h2 class="text-primary mb-3">"<?php echo e($keyword); ?>"</h2>
        <p class="text-muted mb-0">Tìm thấy <strong class="text-success"><?php echo e($products->total()); ?></strong> sản phẩm phù hợp
        </p>
    </div>
    ...
    <?php if($products->count() > 0): ?>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 mb-4">
                    <div class="product-card h-100">
                        ...
                        <div class="card-body d-flex flex-column">
                            <p class="brand-name mb-1"><?php echo e($product->brand->name); ?></p>
                            <h6 class="card-title flex-grow-1">
                                <a href="<?php echo e(route('client.product.show', $product->slug)); ?>" class="text-decoration-none">
                            ...
                            <div class="price-section my-3">
                                <?php if($product->sale_price): ?>
                                    <span class="h5 current-price text-danger mb-0"><?php echo e(number_format($product->sale_price)); ?>đ</span>
                                    <span class="small old-price"><?php echo e(number_format($product->price)); ?>đ</span>
                                <?php else: ?>
                                    <span class="h5 current-price mb-0"><?php echo e(number_format($product->price)); ?>đ</span>
                                <?php endif; ?>
                            </div>

                            <a href="<?php echo e(route('client.product.show', $product->slug)); ?>" class="btn btn-view-detail w-100 mt-auto">
        ...
        <div class="d-flex justify-content-center mt-4">
            <?php echo e($products->appends(['q' => $keyword])->links()); ?>
            ...
            <div class="card-body text-center py-5">
                ...
                <div class="mt-4">
                    ...
                    <div class="d-flex gap-2 justify-content-center flex-wrap">
                        <a href="<?php echo e(route('client.search', ['q' => 'iPhone 15'])); ?>"
                            class="suggestion-badge text-decoration-none">iPhone 15</a>
                        <a href="<?php echo e(route('client.search', ['q' => 'Samsung Galaxy'])); ?>"
                            class="suggestion-badge text-decoration-none">Samsung Galaxy</a>
                        <a href="<?php echo e(route('client.search', ['q' => 'Laptop Dell'])); ?>"
                            class="suggestion-badge text-decoration-none">Laptop Dell</a>
                        <a href="<?php echo e(route('client.search', ['q' => 'Tai nghe Sony'])); ?>"
                            class="suggestion-badge text-decoration-none">Tai nghe Sony</a>
                    </div>
                </div>

                <a href="<?php echo e(route('client.product.all')); ?>" class="btn btn-view-detail mt-4">
    ...
    <?php endif; ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('client.layouts.client', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\chuon\PHP\doanPHP\resources\views/client/product/search.blade.php ENDPATH**/ ?>