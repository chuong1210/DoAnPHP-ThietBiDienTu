...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid">
                ...
                <div class="col-lg-6">
                    <div class="header-content">
                        ...
                        <div>
                            ...
                            <p class="text-muted mb-0">Khám phá <?php echo e($products->total()); ?> sản phẩm</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="header-controls">
                        ...
                        <div class="sort-wrapper">
                            ...
                            <select class="form-select" onchange="sortProducts(this.value)">
                                ...
                                <option value="created_at-DESC" <?php echo e((request('sort') == 'created_at' || !request('sort')) && request('order', 'DESC') == 'DESC' ? 'selected' : ''); ?>>
                                    Mới nhất
                                </option>
                                ...
                                <option value="name-ASC" <?php echo e(request('sort') == 'name' && request('order') == 'ASC' ? 'selected' : ''); ?>>
                                    Tên: A → Z
                                </option>
                                <option value="sold_count-DESC" <?php echo e(request('sort') == 'sold_count' && request('order') == 'DESC' ? 'selected' : ''); ?>>
                                    Bán chạy
                                </option>
                            </select>
                        </div>
        ...
        <!-- Active Filters -->
        <?php if(request()->hasAny(['category_id', 'brand_id', 'price_from', 'price_to'])): ?>
                ...
                <div class="filters-list">
                    <?php if(request('category_id')): ?>
                        <span class="filter-badge">
                            <i class="fas fa-tag"></i> Danh mục: <?php echo e($categories->find(request('category_id'))->name ?? ''); ?>

                            <a href="<?php echo e(route('client.product.index', Illuminate\Support\Arr::except(request()->all(), 'category_id'))); ?>" class="remove-filter">×</a>
                        </span>
                    <?php endif; ?>

                    <?php if(request('brand_id')): ?>
                        <span class="filter-badge">
                            <i class="fas fa-trademark"></i> Thương hiệu: <?php echo e($brands->find(request('brand_id'))->name ?? ''); ?>

                            <a href="<?php echo e(route('client.product.index', Illuminate\Support\Arr::except(request()->all(), 'brand_id'))); ?>" class="remove-filter">×</a>
                        </span>
                    <?php endif; ?>

                    <?php if(request('price_from') || request('price_to')): ?>
                        <span class="filter-badge">
                            <i class="fas fa-dollar-sign"></i> Giá: <?php echo e(number_format(request('price_from', 0))); ?> - <?php echo e(number_format(request('price_to', 0))); ?>đ
                            <a href="<?php echo e(route('client.product.index', request()->except(['price_from', 'price_to']))); ?>" class="remove-filter">×</a>
                        </span>
                    <?php endif; ?>
                </div>
                <a href="<?php echo e(route('client.product.index')); ?>" class="clear-all-filters">
                    ...
                    <div class="product-card">
                        ...
                        <div class="product-content">
                            ...
                            <div class="product-rating">
                                ...
                                <span class="rating-count">(<?php echo e($product->reviews->count()); ?>)</span>
                            </div>
                            ...
                            <div class="product-stock">
                                <?php if($product->quantity > 0): ?>
                                    <span class="stock-badge available">
                                        <i class="fas fa-check-circle"></i> Còn <?php echo e($product->quantity); ?> sp
                                    </span>
                                <?php else: ?>
                            ...
                            <div class="product-actions">
                                ...
                                <?php if($product->quantity > 0): ?>
                                    <form action="<?php echo e(route('client.cart.add', $product->id)); ?>" method="POST" class="add-cart-form">
                                        <?php echo csrf_field(); ?>
            ...
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                <div class="col-span-full">
                    <div class="empty-products">
                        ...
                        <a href="<?php echo e(route('client.product.index')); ?>" class="btn-reset">
...
<?php echo $__env->make('client.layouts.client', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\chuon\PHP\doanPHP\resources\views/client/product/all.blade.php ENDPATH**/ ?>