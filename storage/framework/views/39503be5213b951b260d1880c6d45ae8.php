        ...
        <div class="row g-4">
            ...
            <div class="col-12">
                ...
                <div class="filter-bar">
                    <form method="GET" action="<?php echo e(route('client.product.index')); ?>" class="row g-3 align-items-end">
                        <!-- Search -->
                        <div class="col-lg-3 col-md-6">
                            ...
                            <input type="text" name="keyword" class="form-control modern-input"
                                placeholder="Nhập tên sản phẩm..." value="<?php echo e(request('keyword')); ?>">
                        </div>
                        ...
                        <div class="col-lg-2 col-md-6">
                            ...
                            <select name="sort" class="form-select modern-select">
                                <option value="created_at" <?php echo e(request('sort') == 'created_at' ? 'selected' : ''); ?>>Mới nhất</option>
                                <option value="price" <?php echo e(request('sort') == 'price' ? 'selected' : ''); ?>>Giá tăng dần</option>
                                <option value="price desc" <?php echo e(request('sort') == 'price desc' ? 'selected' : ''); ?>>Giá giảm dần</option>
                            </select>
                        </div>
                ...
                <div class="row g-4">
                    <?php $__empty_1 = true; $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6" style="animation-delay: <?php echo e($index * 0.1); ?>s">
                            <div class="product-card-modern">
                                ...
                                <div class="product-body">
                                    ...
                                    <div class="product-price-wrapper">
                                        <?php if($product->sale_price): ?>
                                            <div>
                                                <span class="price-sale"><?php echo e(number_format($product->sale_price)); ?>đ</span>
                    ...
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        <div class="col-12">
                            <div class="empty-state">
                                ...
                                <a href="<?php echo e(route('client.product.index')); ?>" class="btn btn-filter" style="width: auto; display: inline-flex;">
...
<?php echo $__env->make('client.layouts.client', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\chuon\PHP\doanPHP\resources\views/client/product/index.blade.php ENDPATH**/ ?>