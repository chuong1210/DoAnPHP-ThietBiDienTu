...
<?php $__env->startSection('styles'); ?>
    <style>
        ...
        .form-switch .form-check-input:not(:checked)+.form-check-label .status-text {
            color: #dc3545;
        }
...
<?php $__env->startSection('scripts'); ?>
    <script>
        ...
        // === ĐỔI CHỮ "BẬT/TẮT" KHI CLICK ===
        const checkbox = document.getElementById('is_active');
        const statusText = checkbox.parentElement.querySelector('.status-text');

        // Khởi tạo ban đầu
        statusText.textContent = checkbox.checked ? 'Bật' : 'Tắt';
        statusText.style.color = checkbox.checked ? '#28a745' : '#dc3545';
