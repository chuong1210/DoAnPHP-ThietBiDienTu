        ...
        <nav aria-label="breadcrumb" class="mb-4">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a
                        href="<?php echo e(route('client.product.show', $product->slug)); ?>"><?php echo e(Str::limit($product->name, 30)); ?></a></li>
        ...
        <div class="review-card">
            ...
            <div class="review-card-body">
                ...
                <div class="product-preview">
                    <img src="<?php echo e(asset($product->image ?? 'placeholder.jpg')); ?>"
                ...
                <form action="<?php echo e(route('client.reviews.store', $product->slug)); ?>" method="POST" id="reviewForm">
                    ...
                    <div class="rating-stars-wrapper">
                        <label class="form-label">Bạn đánh giá sản phẩm này thế nào? <span class="text-danger">*</span></label>
