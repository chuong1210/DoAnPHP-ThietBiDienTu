    ...
    <div class="container-fluid">
        ...
        <div class="row py-2 align-items-center"> <!-- Giảm py-3 → py-2 -->
            ...
            <div class="col-md-3 col-6">
                <a href="<?php echo e(route('client.home.index')); ?>" class="text-decoration-none d-flex align-items-center">
                    <div class="logo-icon">
            ...
            <div class="col-md-6 col-12 my-2 my-md-0">
                <form action="<?php echo e(route('client.search')); ?>" method="GET" class="search-wrapper">
            ...
            <!-- User Actions -->
            <div class="col-md-3 col-6 text-end d-flex align-items-center justify-content-end h-100"> <?php if(auth()->guard()->check()): ?>
                <!-- User Dropdown -->
                <div class="dropdown d-inline me-2">
                    <button class="btn btn-user dropdown-toggle" type="button" id="userMenu" data-bs-toggle="dropdown"
                        aria-expanded="false">
                        <div class="avatar-circle">
                            <?php echo e(substr(Auth::user()->full_name, 0, 1)); ?>

                        </div>
                        <span class="d-none d-md-inline ms-2"><?php echo e(Str::limit(Auth::user()->full_name, 10)); ?></span>
                    </button>
                    <ul class="dropdown-menu dropdown-menu-end modern-dropdown">
                        <li class="dropdown-header">
                            <strong class="d-block text-truncate"
                                style="max-width: 220px;"><?php echo e(Auth::user()->full_name); ?></strong>
                        ...
                        <li>
                            <a class="dropdown-item" href="<?php echo e(route('client.my-orders.index')); ?>">
            ...
            <?php else: ?>
                    <!-- Guest Links -->
                    <a href="<?php echo e(route('login')); ?>" class="btn btn-outline-primary btn-sm me-1">
                ...
                <!-- Cart Icon -->
                <a href="<?php echo e(route('client.cart.index')); ?>" class="btn btn-cart position-relative ms-2">
                    <i class="fas fa-shopping-cart"></i>
                    <?php if(auth()->guard()->check()): ?>
                        <?php $cartItemsCount = Auth::user()->cart?->items->sum('quantity') ?? 0; ?>
                        <?php if($cartItemsCount > 0): ?>
                            <span class="cart-badge"><?php echo e($cartItemsCount > 99 ? '99+' : $cartItemsCount); ?></span>
                        <?php endif; ?>
                    <?php endif; ?>
                </a>
            </div>
            ...
            <div class="container-fluid px-0">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav mx-auto gap-1"> <!-- Thêm gap -->
                        <li class="nav-item">
                            <a class="nav-link modern-nav-link <?php echo e(request()->routeIs('client.home.index') ? 'active' : ''); ?>"
                                href="<?php echo e(route('client.home.index')); ?>">
                        ...
                        <li class="nav-item">
                            <a class="nav-link modern-nav-link <?php echo e(request()->routeIs('client.support.index') ? 'active' : ''); ?>"
                                href="<?php echo e(route('client.support.index')); ?>"> <i class="fas fa-headset"></i>
                                <span>Hỗ Trợ</span>
                            </a>
                        </li>
                    </ul>
...
</style><?php /**PATH D:\Nam4\PHP\DoAnPHP-ThietBiDienTu\resources\views/client/partials/header.blade.php ENDPATH**/ ?>