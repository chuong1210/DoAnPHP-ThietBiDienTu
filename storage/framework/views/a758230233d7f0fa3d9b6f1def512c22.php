    ...
    <div class="container-fluid">
        ...
        <div class="filter-tabs">
            <div class="d-flex flex-wrap justify-content-center">
                <button class="btn <?php echo e(!request('status') ? 'active' : ''); ?>" onclick="filterOrders('all')">
                    <i class="fas fa-list"></i> Tất cả
                    <span class="badge"><?php echo e($orders->total()); ?></span>
                </button>
                <button class="btn <?php echo e(request('status') == 'pending' ? 'active' : ''); ?>" onclick="filterOrders('pending')">
                    <i class="fas fa-clock"></i> Chờ xác nhận
                </button>
                <button class="btn <?php echo e(request('status') == 'confirmed' ? 'active' : ''); ?>"
                    onclick="filterOrders('confirmed')">
                    <i class="fas fa-check-circle"></i> Đã xác nhận
                </button>
                <button class="btn <?php echo e(request('status') == 'shipping' ? 'active' : ''); ?>"
                    onclick="filterOrders('shipping')">
                    <i class="fas fa-shipping-fast"></i> Đang giao
                </button>
                <button class="btn <?php echo e(request('status') == 'delivered' ? 'active' : ''); ?>"
                    onclick="filterOrders('delivered')">
                    <i class="fas fa-box"></i> Đã nhận
                </button>
                <button class="btn <?php echo e(request('status') == 'cancelled' ? 'active' : ''); ?>"
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-8">
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    <h5 class="mb-1">Đơn hàng #<?php echo e($order->order_number); ?></h5>
                                    <small>
                                        <i class="far fa-calendar"></i> <?php echo e($order->created_at->format('d/m/Y H:i')); ?>

                                        <span class="mx-2">|</span>
                                        <i class="fas fa-box"></i> <?php echo e($order->items->count()); ?> sản phẩm
                                    </small>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-7">
                            ...
                            <?php $__currentLoopData = $order->items->take(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="d-flex align-items-center mb-3 p-2 bg-light rounded">
                                    <?php if($item->product_image): ?>
                                        <img src="<?php echo e(asset($item->product_image)); ?>" alt="<?php echo e($item->product_name); ?>"
                                            class="product-mini-img me-3">
                                    <?php endif; ?>
                                    <div class="grow">
                                        <h6 class="mb-1"><?php echo e(Str::limit($item->product_name, 50)); ?></h6>
                                        <small class="text-muted">
                                            <?php echo e(number_format($item->price)); ?>đ × <?php echo e($item->quantity); ?>

                                        </small>
                                    </div>
                                    <div class="text-end">
                                        <strong class="text-primary"><?php echo e(number_format($item->subtotal)); ?>đ</strong>
                                    </div>
                                </div>
                            ...
                            <?php if($order->items->count() > 3): ?>
                                <div class="text-center">
                                    <a href="<?php echo e(route('client.my-orders.show', $order->id)); ?>"
                                        class="btn btn-sm btn-outline-primary">
                                        <i class="fas fa-plus"></i> Xem thêm <?php echo e($order->items->count() - 3); ?> sản phẩm
                                    </a>
                                </div>
                            <?php endif; ?>
                        </div>
                        ...
                        <div class="col-md-5">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="bg-light p-2 rounded">
                                    ...
                                    <small class="text-muted">
                                        <i class="fas fa-phone"></i> <?php echo e($order->customer_phone); ?><br>
                                        <?php echo e(Str::limit($order->shipping_address, 60)); ?>
                            ...
                            <div class="d-grid gap-2">
                                <a href="<?php echo e(route('client.my-orders.show', $order->id)); ?>" class="btn btn-primary">
                                    <i class="fas fa-eye"></i> Xem Chi Tiết
                                </a>

                                <?php if(in_array($order->status, ['pending', 'confirmed'])): ?>
                                    <button type="button" class="btn btn-outline-danger"
                                        onclick="showCancelModal(<?php echo e($order->id); ?>, '<?php echo e($order->order_number); ?>')">
                                        <i class="fas fa-times"></i> Hủy Đơn Hàng
                                    </button>
                                <?php endif; ?>
<!-- Thay thế đoạn nút Đánh Giá cũ -->
<?php if($order->status === 'delivered' && $order->items->where('reviewed', false)->count() > 0): ?>
    <div class="mt-3">
        <h6 class="mb-2">
            <i class="fas fa-star text-warning"></i> Đánh giá sản phẩm
        </h6>
        <div class="d-grid gap-2">
            <?php $__currentLoopData = $order->items->where('reviewed', false)->take(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a href="<?php echo e(route('client.reviews.create', $item->product->slug)); ?>"
                   class="btn btn-outline-success btn-sm">
                    <i class="fas fa-star"></i>
                    Đánh giá: <?php echo e(Str::limit($item->product_name, 30)); ?>

                </a>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>

            <?php if($order->items->where('reviewed', false)->count() > 3): ?>
                <small class="text-muted text-center">
                    Còn <?php echo e($order->items->where('reviewed', false)->count() - 3); ?> sản phẩm chưa đánh giá
                </small>
            <?php endif; ?>
        </div>
    </div>
...
<?php endif; ?>
                    ...
                    <?php if($order->discount > 0): ?>
                        <div class="alert alert-success mt-3 mb-0">
                            ...
                            <strong><?php echo e(number_format($order->discount)); ?>đ</strong> từ đơn hàng này
                        </div>
                    <?php endif; ?>
                </div>
                ...
                <div class="card-footer bg-light">
                    <div class="row text-center">
                        <div class="col">
                            ...
                            <strong><?php echo e($order->created_at->format('d/m H:i')); ?></strong>
                        </div>
                        <div class="col">
                            <small class="text-muted">Xác nhận</small><br>
                            <strong><?php echo e($order->status !== 'pending' ? '✓' : '⏳'); ?></strong>
                        </div>
                        <div class="col">
                            <small class="text-muted">Giao hàng</small><br>
                            <strong><?php echo e(in_array($order->status, ['shipping', 'delivered']) ? '✓' : '⏳'); ?></strong>
                        </div>
                        <div class="col">
                            <small class="text-muted">Hoàn thành</small><br>
                            <strong><?php echo e($order->status === 'delivered' ? '✓' : '⏳'); ?></strong>
                        </div>
                    </div>
                </div>
            </div>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
            ...
            <div class="empty-state">
                ...
                <a href="<?php echo e(route('client.product.index')); ?>" class="btn btn-primary btn-lg">
...
<?php $__env->startSection('scripts'); ?>
    <script>
        ...
        function filterOrders(status) {
            if (status === 'all') {
                window.location.href = '<?php echo e(route("client.my-orders.index")); ?>';
            } else {
                window.location.href = '<?php echo e(route("client.my-orders.index")); ?>?status=' + status;
            }
        }
...
<?php echo $__env->make('client.layouts.client', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\chuon\PHP\doanPHP\resources\views/client/orders/index.blade.php ENDPATH**/ ?>