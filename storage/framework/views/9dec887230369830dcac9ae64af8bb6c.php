            ...
            <div class="row g-4">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="footer-brand">
                        <div class="d-flex align-items-center mb-3">
                            ...
                            <h4 class="ms-2 mb-0 footer-brand-name">Tech Shop</h4>
                        </div>
                        <p class="footer-description">
                            Chuyên cung cấp các sản phẩm điện tử, công nghệ chính hãng với giá tốt nhất.
                ...
                <div class="col-lg-2 col-md-6">
                    ...
                    <ul class="footer-links">
                        <li><a href="#"><i class="fas fa-angle-right"></i> Bảo hành</a></li>
                        <li><a href="#"><i class="fas fa-angle-right"></i> Đổi trả</a></li>
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <ul class="footer-links">
                        ...
                        <li><a href="#"><i class="fas fa-angle-right"></i> Kiểm tra đơn hàng</a></li>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-6 text-center text-md-start mb-2 mb-md-0">
                    <p class="mb-0">
                        © 2024 <strong>Tech Shop</strong>. All rights reserved.
                    </p>
                </div>
...
</script><?php /**PATH D:\Nam4\PHP\DoAnPHP-ThietBiDienTu\resources\views/client/partials/footer.blade.php ENDPATH**/ ?>